 ...
 *
 * <p> Reimplement the sort() method using only the Stream API and lambdas and/or method references.
 */
final class WordCounts {
   ...
   *
   * <p> Reimplement this method using only the Stream API and lambdas and/or method references.
   *
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    return wordCounts.entrySet().stream()
            // Sort the entries using the WordCountComparator
            .sorted(new WordCountComparator())
            // Limit the stream to the specified popularWordCount
            .limit(popularWordCount)
            // Collect the entries back into a map
